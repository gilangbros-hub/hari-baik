            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-md">
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                        <button
                            type="button"
                            className={formData.role === 'CPP' ? 'btn-primary' : 'btn-outline'}
                            style={{ flex: 1 }}
                            onClick={() => setFormData({ ...formData, role: 'CPP' })}
                        >
                            CPP
                        </button>
                        <button
                            type="button"
                            className={formData.role === 'CPW' ? 'btn-primary' : 'btn-outline'}
                            style={{ flex: 1 }}
                            onClick={() => setFormData({ ...formData, role: 'CPW' })}
                        >
                            CPW
                        </button>
                    </div>
                ...
                <button type="submit" className="btn-primary mb-md">
                    Lanjutkan
                </button>
